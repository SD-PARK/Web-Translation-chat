...
$('div#langForm > select').val(getCookie('setLang')).prop('selected', true); // 페이지 언어 설정
$('form#register > select').val(getCookie('setLang')).prop('selected', true); // register 내 회원 정보의 언어 설정